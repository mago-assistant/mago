...
class ChatService implements ChatServiceInterface
{
    ...
    private function getToolStatusMessage(string $toolName, string $action, array $input): string
    {
        $messages = [
            ...
            'product_media.generate_image' => 'Starting image generation...',
            'product_media.generate_video' => 'Starting video generation...',
            'product_media.check_status' => 'Checking generation status...',
            'product_media.attach_image' => 'Adding image to product...',
